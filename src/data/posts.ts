...
export const posts: Post[] = [
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "ZEROデザインは、CAMPFIRE公式パートナーとして、クラウドファンディングの企画・ページ制作から、LINE公式アカウント・SNSを使った公開後の関係づくりまで一貫して伴走します。お寺のクラウドファンディングとその後の運用をご検討の方は、まずはお気軽にご相談ください。",
      },
      {
        type: "cta",
        text: "支援を「続くご縁」に変える仕組みづくりを、ゼロからお手伝いします。",
